...
describe('Merkle proof data structure', () => {
  describe('packing correctness', () => {
    it('binary to object', () => {
      ...
      const result = proofing.packObject({
        "index": 12,
      ...
      assert.equal(Buffer.compare(result, binaryData), 0)
    })
  })
  ...
  describe('target type independent cases', () => {
    it('should reject unrecognized flags', () => {
      ...
      const binaryDataHex = 'FF0069f17b44cfe9c2a23285168fe05084e1254daa5305311ed8cd95b19ea6b0ed7569f17b44cfe9c2a23285168fe05084e1254daa5305311ed8cd95b19ea6b0ed7500'
      const binaryData = Buffer.from(binaryDataHex, 'hex')
      assert.throws(() => {
    ...
    it('should reject the "tree" proof type', () => {
      ...
      const binaryDataHex = '0c0069f17b44cfe9c2a23285168fe05084e1254daa5305311ed8cd95b19ea6b0ed7569f17b44cfe9c2a23285168fe05084e1254daa5305311ed8cd95b19ea6b0ed7500'
      const binaryData = Buffer.from(binaryDataHex, 'hex')
      assert.throws(() => {
        proofing.VerifyMerkleProof(binaryData, {})
      }, Error)
    ...
    it('should reject composite proofs', () => {
      ...
      const binaryDataHex = '140069f17b44cfe9c2a23285168fe05084e1254daa5305311ed8cd95b19ea6b0ed7569f17b44cfe9c2a23285168fe05084e1254daa5305311ed8cd95b19ea6b0ed7500'
      const binaryData = Buffer.from(binaryDataHex, 'hex')
      assert.throws(() => {
        proofing.VerifyMerkleProof(binaryData, {})
      }, Error)
    ...
    it('should reject an invalid merkle root', () => {
      ...
      const binaryData = Buffer.from(binaryDataHex, 'hex')
      let result = proofing.VerifyMerkleProof(binaryData, {})
    ...
    it('should reject a last element of an uneven tree if on the right', () => {
      const binaryDataHex = ''
      const binaryData = Buffer.from(binaryDataHex, 'hex')
      assert.throws(() => {
        proofing.VerifyMerkleProof(binaryData, {})
      }, Error)
  ...
  describe('"hash" target type related cases', () => {
    it('should accept a valid transaction as implicit target type', () => {
      ...
      const binaryData = Buffer.from(binaryDataHex, 'hex')
      let result = proofing.VerifyMerkleProof(binaryData, mapHashToHeader)
      assert.deepEqual(result, {
          isLastInTree: false,
          proofValid: true
      })
